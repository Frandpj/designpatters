...
const fran = personBuilder.setName("Fran").setLastName("del Pino").addHobby("Jugar").addHobby("Programar").build();
console.log(fran);

const juan = personBuilder.setName("Juan").setLastName("Pérez").addHobby("Comer").setCountry("España").addHobby("Cerveza").build();
console.log(juan);
